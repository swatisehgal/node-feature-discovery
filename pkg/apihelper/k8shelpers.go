...
func (h K8sHelpers) GetPods(cli *k8sclient.Clientset, namespace string) (*api.PodList, error) {
	return cli.CoreV1().Pods(namespace).List(context.TODO(), meta_v1.ListOptions{})
}
